...
const InputField = () => {
    ...
    return (
        <div className="w-full h-[7%] dark:border-t-[#323657]  border-t border-t-[white] border-l-[white] dark:border-l-[#323657]  border-l bg-[#B5BFC6] dark:bg-[#24273C] flex flex-row justify-between items-center px-[30px] relative">
            ...
            />
            {img ? (
                <p className="text-[10px] font-[300]">{img?.name}</p>
            ) : (
                <label htmlFor="file">
                    <Image
                        src={uploadPhoto}
            ...
            <textarea
                ...
                value={text}
                className="w-full h-full ml-[15px] text-start bg-[#B5BFC6] dark:bg-[#24273C] outline-none text-[15px] font-[200] Manr resize-none placeholder:text-[14px] dark:placeholder:text-[#737482] placeholder:text-[white] px-[10px] pt-[12px]"
            ...
            <EmojiPicker
                ...
                className="absolute hidden ipadBig:flex left-[00%] top-[-550%] !w-[500px]"
            />
            <Image
                onClick={hidePanel}
                src={frog}
                alt="icon"
                className="size-[30px] cursor-pointer mr-[20px] hidden ipadBig:flex"
            />
            <Image
                onClick={sendMessage}
                src={message}
