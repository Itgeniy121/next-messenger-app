...
const LoginForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col justify-center items-start w-full mt-[40px]">
    ...
    <div className="flex flex-row mt-[15px]">
      <p className="text-[15px] text-[#9495A4] font-[200]">Еще нет аккаунта?</p>
      &nbsp;&nbsp;&nbsp;
      <Link href="/auth" className="text-[15px] text-[#EE3A57] font-[300] hover:underline">Создать</Link>
    </div>
