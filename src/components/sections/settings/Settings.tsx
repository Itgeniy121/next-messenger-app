  ...
  return (
    <div className="w-full h-[100vh] flex flex-col justify-start items-center">
        ...
        <div className="w-full flex flex-col justify-center items-center mt-[30px]">
            <div className='relative flex cursor-pointer' onClick={avatarUpdate}>
                ...
                {!isLoading && userPhoto && <Image width={100} height={100} src={userPhoto} alt="avatar" className="size-[100px] z-[99999] rounded-[50%] hover:opacity-30"/>}
                {!isLoading && !userPhoto && <Image width={100} height={100} src={avatar} alt='avatar' className="size-[100px] z-[99999] rounded-[50%] hover:opacity-30"/>}
            </div>
            <p className="text-[18px] dark:text-[white] text-[#9495A4] nunito font-[300] mt-[15px] hover:underline cursor-pointer" onClick={avatarUpdate}>Сменить аватар</p>
        </div>
        <ThemeSwitcher/>
    </div>
  )
